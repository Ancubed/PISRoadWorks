...
import ExectorPie from '../../../components/common/executorPie'
    ...
    return (
        <main>
            ...
            <div className='flex flex-wrap lg:flex-nowrap'>
                <div className="mr-2 flex flex-col basis-1/3 grow lg:grow-0 mb-4 lg:mb-0 ">
                    <div className="my-2">
                ...
                <RoadWorksLinksList executor={props.account.id} className='basis-1/3'/>
                <div className='flex flex-col w-full lg:basis-1/3 lg:ml-4 mt-6 lg:mt-0 items-center'>
                    <h1 className="text-2xl mb-4">Статистика</h1>
                    <ExectorPie executor={props.account.id}/>    
                </div>
            </div>
        </main>
    )
